...
export class NavbarComponent {
  ...
  iconPaths: Record<string, string> = {
    ...
    account: 'M9 7h6m0 10v-3m-3 3v-6m-3 6v-1M3 17V7a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2z',
    ...
    accounting: 'M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2',
  ...
  settingsExtraPath = 'M15 12a3 3 0 11-6 0 3 3 0 016 0z';
}
