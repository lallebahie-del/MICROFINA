...
class AppTextStylesExtensions extends ThemeExtension<AppTextStylesExtensions> {
  ...
  @override
  AppTextStylesExtensions lerp(ThemeExtension<AppTextStylesExtensions>? other, double t) {
    ...
    return AppTextStylesExtensions(
      ...
      transactionAmount: TextStyle.lerp(transactionAmount, other.transactionAmount, t),
    );
  }
}
