...
class _NewLoanRequestScreenState extends State<NewLoanRequestScreen> {
  ...
  void _submitRequest() {
    if (_formKey.currentState!.validate()) {
      context.read<LoanBloc>().add(SubmitLoanRequest(
  ...
  Widget build(BuildContext context) {
    return BlocListener<LoanBloc, LoanState>(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Demande de Crédit', style: TextStyle(fontWeight: FontWeight.w800)),
          centerTitle: true,
          elevation: 0,
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (val) {
                    ...
                    if (double.tryParse(val) == null || double.parse(val) < 100000) return 'Minimum 100 000 FCFA';
                    return null;
                  },
                ),
                ...
                DropdownButtonFormField<String>(
                  ...
                  validator: (val) {
                    if (val == null || val.isEmpty) return 'Veuillez sélectionner un motif';
                    return null;
                  },
                ),
